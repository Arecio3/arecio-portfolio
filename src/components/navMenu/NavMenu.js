        ...
        <nav className={"nav-menu "+ (!menuOpen && "Close")}>
            ...
            <div className="nav-menu-inner">
                <ul>
                    ...
                    <li><a href="/" className="outer-shadow hover-in-shadow">About</a></li>
                    <li><a href="/" className="outer-shadow hover-in-shadow">Services</a></li>
                    <li><a href="/" className="outer-shadow hover-in-shadow">Portfolio</a></li>
